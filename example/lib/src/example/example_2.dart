...
const example2 = Example(
  ...
  description: 'With TimelineAlign.center you can configure both start and end '
      'children. But when providing children to the tile the height '
      '(axis vertical) or the width (axis horizontal) will be as minimum as '
      'possible, so you can control it with a height/width constraint (at least minHeight/minWidth). '
